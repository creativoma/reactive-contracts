/**
 * Auto-generated runtime negotiator for Posts contract
 ...
 */
export function createPostsNegotiator(contract: Contract): PostsNegotiator {
  return new PostsNegotiator(contract);
}
