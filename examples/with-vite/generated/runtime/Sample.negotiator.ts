/**
 * Auto-generated runtime negotiator for Sample contract
 ...
 */
export function createSampleNegotiator(contract: Contract): SampleNegotiator {
  return new SampleNegotiator(contract);
}
